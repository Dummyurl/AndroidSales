...
import pandu.ptbintangpos.util.CustomVolleyJsonRequest;
...
public class Product_fragment extends Fragment {
    ...
    private List<Produk_model> product_modelList = new ArrayList<>();
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (status) {
                        ...
                        Gson gson = new Gson();
                        Type listType = new TypeToken<List<Produk_model>>() {
                        }.getType();
