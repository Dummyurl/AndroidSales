...
import pandu.ptbintangpos.Model.Produk_model;
...
public class Product_adapter extends RecyclerView.Adapter<Product_adapter.MyViewHolder>
    ...
    private List<Produk_model> modelList;
    ...
    public Product_adapter(List<Produk_model> modelList, Context context) {
    ...
    public void onBindViewHolder(Product_adapter.MyViewHolder holder, int position) {
        Produk_model mList = modelList.get(position);
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    ArrayList<Produk_model> filteredList = new ArrayList<>();

                    for (Produk_model androidVersion : modelList) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                mFilteredList = (ArrayList<Produk_model>) filterResults.values;
