...
import pandu.ptbintangpos.Fragment.Add_delivery_address_fragment;
import pandu.ptbintangpos.Model.Delivery_address_model;
            ...
            rb_select.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (cb.isChecked()) {
                        ...
                        Intent updates = new Intent("Bintang_delivery_charge");
