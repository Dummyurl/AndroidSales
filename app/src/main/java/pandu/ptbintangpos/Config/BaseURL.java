package pandu.ptbintangpos.Config;



public class BaseURL {

    public static final String PREFS_NAME = " BintangLoginPrefs";

    public static final String PREFS_NAME2 = "BintangLoginPrefs2";
    ...
    public static final String KEY_UID = "user_gcm_code";
